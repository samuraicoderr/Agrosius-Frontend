# Agrosius API Endpoints Documentation
...
Agrosius is an intelligent crop recommendation API that predicts the most suitable crops based on soil and climate conditions using machine learning models.
...
export const api = new AgrosiusAPI();
```
